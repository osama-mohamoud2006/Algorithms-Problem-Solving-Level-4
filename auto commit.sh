...
project_dir="E:/projects/c++ course/08 - Algorithms & Problem Solving Level 4"
cd "$project_dir" || exit  
...
snapshot_dir="E:/projects/_snapshots_algorithms_lvl4"
...
git remote add origin "https://github.com/osama-mohamoud2006/Algorithms-Problem-Solving-Level-4.git"
